...
/**
 * Saves a poll answer
 * @param {object} pollAnswer Answer to save
 */
const savePollAnswer = pollAnswer => {
  const { authedUser, id, answer } = pollAnswer;
...
export { getUsers, getPolls, savePoll, savePollAnswer };
